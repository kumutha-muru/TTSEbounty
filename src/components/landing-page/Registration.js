...
import BecomeADeliveryMan from "../../../public/landingpage/Become a Delivery Man2.svg";
import BecomeASeller from "../../../public/landingpage/Become a Seller 1.svg";
      ...
      <Grid container spacing={3} alignItems="center" justifyContent="center">
        ...
        <Grid item xs={5}>
          <Stack alignItems="flex-start" justifyContent="flex-start">
            ...
            >
              <DollarSignHighlighter theme={theme} text={headingText || ""} />
            </Typography>
            <Typography
              ...
              textAlign="flex-start"
            >
              <DollarSignHighlighter theme={theme} text={subtitleText || ""} />
            </Typography>
          </Stack>
        </Grid>
