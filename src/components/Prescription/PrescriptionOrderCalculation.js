...
const PrescriptionOrderCalculation = ({
    ...
    const storeDeliverySystem = (storeData,deliveryFee) => {
    ...
    const zoneDeliverySystem = (configData, orderType, zoneData,deliveryFee) => {
    ...
    const getPrescriptionDeliveryFees = (
      ...
      if (Number.parseInt(storeData?.self_delivery_system) === 1) {
        return storeDeliverySystem(storeData,deliveryFee);
      } else {
        return zoneDeliverySystem(configData, orderType, zoneData,deliveryFee);
      }
    };
