...
import eBusinessSolution from "../../../public/landingpage/Complete Multipurpose eBusiness Solution.svg";
	...
	return (
		<>
			{(Number.parseInt(
				...
				<ComponentTwoContainer paddingTop="2rem" paddingBottom="0">
					<CustomContainer>
						<Grid
							container
							alignItems="center"
							...
							>
								...
								>
									<CustomImageContainer
                                        ...
                                        height={isSmall ? "80%" : "80%"}
                                        objectfit="contained"
                                        src={eBusinessSolution.src}
                                    />
								</Box>
							</Grid>
							<Grid
