...
const BestReviewedItems = (props) => {
  const { title, bannerData, bannerIsLoading} = props;
  const url = `${bannerData?.promotional_banner_url}/${bannerData?.best_reviewed_section_banner}`;
  ...
  const smallDevice= bannerData?.best_reviewed_section_banner ? 9 : 12
  const {
    data,
    refetch,
  ...
  const bestReviewedSliderSettings = {
    ...
    infinite: false,
    speed: 500,
    slidesToShow: bannerData?.best_reviewed_section_banner ? 4 : 5,
    slidesToScroll: 2,
    cssEase: "linear",
    responsive: [
      {
      ...
      },
      {
        breakpoint: 1150,
        settings: {
          slidesToShow: bannerData?.best_reviewed_section_banner ? 1.6 : 2.1,
          slidesToScroll: 1,
        },
      },
    ],
  ...
  const foodBestReviewedSliderSettings = {
    ...
    slidesPerRow: 1,
    rows: 2,
    slidesToShow: bannerData?.best_reviewed_section_banner ? 2.1 : 2.7,
    slidesToScroll: 1,
    cssEase: "linear",
    responsive: [
      {
          ...
          {bestReviewedItems && bestReviewedItems?.products?.length > 0 && (
            ...
            >
              ...
              <CustomBoxFullWidth>
                ...
                >
                  {bannerData?.best_reviewed_section_banner && (
                  ...
                  <Grid
                    ...
                    xs={12}
                    sm={smallDevice}
                    md={bannerData?.best_reviewed_section_banner ? 9.5 : 12}
                  >
