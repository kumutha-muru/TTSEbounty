...
export const vehiclesList = "/api/v1/get-vehicles";
export const zoneList = "/api/v1/zone/list";
export const get_zone_coordinates_api= "/admin/zone/get-coordinates";
export const subscription_plan_List = "/api/v1/subscription_plans";
export const order_summary_api = "/api/v1/getOrderSummary";
