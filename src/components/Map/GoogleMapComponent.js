...
const GoogleMapComponent = ({
  ...
  const isSmallStyle = isSmall ? "250px" : "450px";
  const heightStyle = height || isSmallStyle;
  const containerHeight = isModalExpand ? "70vh" : heightStyle;
  ...
  return isLoaded ? (
    ...
    >
      <GoogleMap
        ...
        options={options}
      >
        {!locationLoading ? loadingLocation : circleProgressComponent}
      </GoogleMap>
    </Stack>
  ) : (
    <></>
