export const arabic = {
  ...
  Select_Delivery_Time_Type:"حدد نوع وقت التسليم",
  please_select_deliver_type:"يرجى تحديد نوع التسليم.",
  Upload_Cover_Photo_Ratio_2_1:"تحميل صورة الغلاف (نسبة 2:1)",
  Upload_Store_Logo_Ratio_1_1:" تحميل شعار المتجر (نسبة 1:1)",
  Select_Zone:"حدد المنطقة",
  System_Module:"وحدة النظام",
  Select_Module:"حدد الوحدة النمطية",
  Store_Type:"نوع المتجر",
  wholesale:"بالجملة",
  retail:"بيع بالتجزئة",
  Address_Info:"معلومات العنوان",
  Address_Note:"(ملاحظة:-يرجى اختيار موقع المتجر من المنطقة المختارة.)",
  City:"مدينة",
  District:"يصرف",
  State:"ولاية",
  Pincode:"الرمز السري",
  ...
  Category_wise_Percentage:"الفئة النسبة المئوية الحكيمة",
  Plan:"يخطط",
  "Select Plan":"اختر خطة",
  "Commission (%)":"عمولة (٪)",
  "Enter captcha":"أدخل كلمة التحقق",
  "Invalid recaptcha":"اختبار التحقق غير صالح",
  "Login Info":"معلومات تسجيل الدخول",
  "Store Info":"معلومات المتجر",
  Instructions:"تعليمات",
  "Store Registration":"تسجيل المتجر",
  "Phone number must be 10 digits":"رقم الهاتف يجب أن يكون 10 أرقام",
  "The phone should not be more than 10 characters":"يجب ألا يزيد عدد أحرف الهاتف عن 10 أحرف",
  "Password must contain at least 8 characters, one uppercase, one number and one special case character":"يجب أن تحتوي كلمة المرور على 8 أحرف على الأقل، وحرف كبير واحد، ورقم واحد، وحرف حالة خاصة واحد",
  "Store name is required":"اسم المتجر مطلوب",
  "Store type is required":"نوع المتجر مطلوب",
  "Longitude is required":"مطلوب خط الطول",
  "Latitude is required":"مطلوب خط العرض",
  ...
  "Enter recaptcha":"أدخل كلمة التحقق",
  "Maximum time is required":"الحد الأقصى للوقت مطلوب",
  "Minimum delivery time type is should be greater than Maximum delivery time type":"يجب أن يكون الحد الأدنى لنوع وقت التسليم أكبر من الحد الأقصى لنوع وقت التسليم",
  "Minimum time is required":"الحد الأدنى من الوقت مطلوب",
  "Delivery time type is required":"نوع وقت التسليم مطلوب",
  "Please Choose an Category.":"الرجاء اختيار فئة",
  "please choose subscription":"الرجاء اختيار الاشتراك",
  "The identity image field is required":"حقل صورة الهوية مطلوب",
  "Please choose plan.":"الرجاء اختيار الخطة.",
  "Please choose module":"الرجاء اختيار الوحدة",
  "Please choose store type":"الرجاء اختيار نوع المتجر",
  "Please choose zone":"الرجاء اختيار المنطقة",
  "Deliveryman Info":"معلومات عامل التوصيل",
  "Deliveryman Type":"نوع مندوب التوصيل",
  "Select Deliveryman Type":"حدد نوع مندوب التوصيل",
  Vehicle:"عربة",
  "Select Vehicle":"اختر مركبة",
  "The vehicle field is required!":"حقل السيارة مطلوب!",
  "The identity type is required!":"نوع الهوية مطلوب!",
  "Deliveryman Image":"صورة مندوب التوصيل",
  "Deliveryman image is required":"صورة مندوب التوصيل مطلوبة",
  "Captcha is required":"كلمة التحقق مطلوبة",
  "The firstname field is required!":"الحقل الأول مطلوب!",
  "The firstname must be atleast 3 characters":"يجب أن يتكون الاسم الأول من 3 أحرف على الأقل",
  "The firstname should not be more than 80 characters":"يجب ألا يزيد طول الاسم الأول عن 80 حرفًا",
  "The lastname field is required!":"حقل الاسم الأخير مطلوب!",
  "The lastname must be atleast 1 characters":"يجب أن يتكون الاسم الأخير من حرف واحد على الأقل",
  "The lastname should not be more than 80 characters":" يجب ألا يزيد اسم العائلة عن 80 حرفًا",
  "Please enter a valid email":"يرجى إدخال البريد الإلكتروني الصحيح",
  "The identity number field is required!":"حقل رقم الهوية مطلوب!",
  "The identity number must be atleast 1 characters":"يجب أن يتكون رقم الهوية من حرف واحد على الأقل",
  "Please Contact Admin For Registration":"يرجى الاتصال بالمسؤول للتسجيل",
  "Delivery services:":"خدمات توصيل:",
  "TTS emart fullfilled services: Orders to be delivered to customers by TTS emart delivery application only Hybrid: - Orders may be delivered to customers by TTS emart or by the Merchants using our delivery application. If the vendor has self managed delivery option then the vendor is responisble for delivering thier customer orders where as if the self managed delivery is not assigned the TTS emart is responisble for delivering thier vendors customer orders. The service shall be in accordance with the terms and conditions":"خدمات TTS emart الكاملة: سيتم تسليم الطلبات للعملاء عن طريق تطبيق التسليم TTS emart فقط الهجين: - يمكن تسليم الطلبات للعملاء عن طريق TTS emart أو عن طريق التجار باستخدام تطبيق التسليم الخاص بنا. إذا كان لدى البائع خيار التسليم المُدار ذاتيًا، فسيكون البائع مسؤولاً عن تسليم طلبات العملاء الخاصة به، كما لو لم يتم تعيين التسليم المُدار ذاتيًا، فإن TTS emart مسؤول عن تسليم طلبات العملاء الخاصة بالموردين. يجب أن تكون الخدمة وفقا للشروط والأحكام",
  "Subscription fee:":"رسم الاشتراك:",
  "In consideration of the services, the vendor hereby agrees to pay TTS emart based on the subscription plan as a registration fee for the mentioned time period. After that the vendor has to renew to continue the benefits of TTS emart. The subscription fee shall by payable by the vendor via CASH/CHEQUE (Drawn in the name of “Techmango Technology private limited”) or Bank transfer (Bank account details for bank are mentioned below) or online payment mode (card or netbanking). Either way the vendor can make subscription payments.":"مقابل الخدمات، يوافق البائع بموجب هذا على دفع TTS emart بناءً على خطة الاشتراك كرسوم تسجيل للفترة الزمنية المذكورة. بعد ذلك يتعين على البائع التجديد لمواصلة مزايا TTS emart. يجب أن يدفع البائع رسوم الاشتراك عن طريق النقد/الشيك (المسحوبة باسم 'Techmango Technology Private Limited') أو التحويل البنكي (تفاصيل الحساب البنكي للبنك مذكورة أدناه) أو وضع الدفع عبر الإنترنت (البطاقة أو الخدمات المصرفية عبر الإنترنت). وفي كلتا الحالتين يمكن للبائع سداد دفعات الاشتراك.",
  "Flat or category wise percentage plan:":"خطة النسبة المئوية المسطحة أو الحكيمة للفئة:",
  "Another option for the vendor to register by choosing either flat admin percentage or category wise admin percentage based on the orders placed by the vendor customer.":"هناك خيار آخر للمورد للتسجيل عن طريق اختيار إما النسبة المئوية للمسؤول الثابت أو النسبة المئوية للمسؤول حسب الفئة بناءً على الطلبات المقدمة من عميل المورد.",
  "Commission Percentage exclusive of Payment Gateway Fee:":"نسبة العمولة باستثناء رسوم بوابة الدفع:",
  "Payment Gateway Fee:":"رسوم بوابة الدفع:",
  "Vendor shall pay a payment gateway fee of 2% fixed cost per transaction respectively on the order value. The aforementioned fee is applicable for online paid order(s) only.":"يجب على البائع دفع رسوم بوابة الدفع بنسبة 2% من التكلفة الثابتة لكل معاملة على التوالي من قيمة الطلب. تنطبق الرسوم المذكورة أعلاه على الطلب (الطلبات) المدفوعة عبر الإنترنت فقط.",
  "Payments Mechanism Offered to Process Customer Orders:":"آلية الدفع المقدمة لمعالجة طلبات العملاء:",
  "1. Cash on Delivery":"1. الدفع عند الاستلام",  
  "2. Electronic Payment Mechanism (Credit Card/debit Card/Net banking Transfer and / or e-wallets and":"2. آلية الدفع الإلكتروني (بطاقة الائتمان / بطاقة الخصم / صافي التحويل المصرفي و / أو المحافظ الإلكترونية و",
  "3. Redemption of vouchers and/or discount coupons (as applicable) provided by TTS eMart.":"3. استرداد القسائم و/أو كوبونات الخصم (حسب الاقتضاء) المقدمة من TTS eMart.",
  "Payment Settlement Process:":"عملية تسوية الدفع:",
  "Any order payment amount done by the customer will be directly transferred to the vendors merchant account and the respetive admin commission would be transferred to the TTS eMart's payment gateway merchant account immediately.Based on the delivery man assinged.":"سيتم تحويل أي مبلغ دفع للطلب يقوم به العميل مباشرةً إلى حساب التاجر الخاص بالبائع وسيتم تحويل عمولة الإدارة المعنية إلى حساب التاجر في بوابة الدفع الخاصة بـ TTS eMart على الفور. استنادا إلى رجل التسليم مُكَلَّف.",
